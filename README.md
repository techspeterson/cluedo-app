...
Two major parts of the app functionality are described here in flowchart form: the `create_game` method that runs when a new game is started, and the `make_guess` method that runs when the user is making a guess.
